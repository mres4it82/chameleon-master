...
class DelayPermissionDetails extends GetView<HomeController> {
  @override
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        controller.allEmployeesDelayPermission.value.data?[0]
                          ...
                          flex: 2,
                          child: Text(
                              '${controller.allEmployeesDelayPermission.value
                        ...
                        controller.allEmployeesDelayPermission.value.data?[0]
                            ...
                            Text(
                                i.DateFormat('yyyy-MM-dd').format(
                                    DateTime.parse(
                                        controller.allEmployeesDelayPermission
                                            .value
                                            .data?[0]
                                            .employeesPermissions?[controller
                                            .indexLoan
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          flex: 2,
                          child: controller.allEmployeesDelayPermission.value
                              .data?[0].employeesPermissions?[controller
                              .indexLoan.value]
                              .duration ==
                              null
...
class DelayPermissionReqDetails extends GetView<HomeController> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          flex: 2,
                          child: controller.allEmployeesDelayPermissionReq.value
                              .data?[0].employeesPermissions?[controller
                              .indexHoliday.value]
                              .duration ==
                              null
