...
class DelayPermissionTable extends GetView {
  final List<EmployeesPermissions> selectedItems;

  DelayPermissionTable({required this.selectedItems});
    ...
    return Container(
        ...
        child: InkWell(
          onTap: () {
            ...
            controller.showEmployeesDelayPermission.value = true;
          },
          child: const Icon(
    ...
    return Row(
      children: <Widget>[
        Container(
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: controller.allEmployeesDelayPermission.value.data?[0]
